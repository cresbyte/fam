      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-responsive-lg text-muted-foreground max-w-2xl mx-auto">
              Our experienced educators and language specialists are passionate
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <motion.div
                ...
                custom={index + 1}
                whileHover={{ y: -8 }}
                className="card-minimal text-center bg-white/80 border border-border rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300"
              ...
              >
                ...
                <div className="text-responsive-base text-primary font-medium mb-4">
                  {member.role}
                </div>
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    {member.specialties.map((specialty, specialtyIndex) => (
                      <motion.span
                        ...
                        className="bg-primary/10 text-primary px-3 py-1 rounded-full text-responsive-sm font-medium"
                      >
                        {specialty}
                      </motion.span>
                    ))}
